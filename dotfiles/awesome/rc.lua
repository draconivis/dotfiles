...
local awesomemenu = {
    { "autorandr",   function() awful.spawn.with_shell("autorandr -c") end },
...
local sessionmenu = {
    ...
    { "lock",     function() awful.spawn.with_shell(lock_command) end },
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn.with_shell("wpctl set-volume @DEFAULT_SINK@ 2%+") end),
    awful.key({}, "XF86AudioLowerVolume", function() awful.spawn.with_shell("wpctl set-volume @DEFAULT_SINK@ 2%-") end),
    awful.key({}, "XF86AudioMute", function() awful.spawn.with_shell("wpctl set-mute @DEFAULT_SINK@ toggle") end),
    ...
    -- session
    awful.key({ modkey }, "l", function() awful.spawn.with_shell(lock_command) end,
        { description = "Lock session", group = "session" }),
    awful.key({ modkey }, "a", function() awful.spawn.with_shell("autorandr -c") end,
        { description = "apply autorandr config", group = "session" })
)
